<div class="Pane Pane--underSiteNav Pane--cropFull" data-url="<?= $template['assets'].'core/css/images/Pane-dirtLight.18def74ed60ab9f1f4139f87349d2f79.jpg'; ?>" media-medium="!hide" queryselectoralways="0 31" media-original="Pane Pane--underSiteNav Pane--cropFull hide">
<div class="Pane-bg" style="background-color:#041828;background-image:url(&quot;<?= $template['assets'].'core/css/images/Pane-dirtLight.18def74ed60ab9f1f4139f87349d2f79.jpg'; ?>&quot;);">
              ...
              <div class="uk-card-header">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  ...
                  <div class="uk-width-auto@s">
                    <p class="uk-text-small" style="font-size:13px"><i class="far fa-clock"></i> <?= date('F j, Y, h:i a', $this->news_model->getNewlogDate($idlink)); ?></p>
                  </div>
                </div>
              </div>
            ...
            <div class="uk-card uk-card-default">
              ...
              <div class="uk-card-body">
                <ul class="uk-list uk-list-divider uk-text-small">
                  ...
                  <li>
                    <a href="<?= base_url('news/'.$list->id) ?>" style="font-size:16px"><i class="far fa-newspaper"></i> <?= $list->title ?></a>
                  </li>
                  <?php endforeach; ?>
                </ul>
              </div>
