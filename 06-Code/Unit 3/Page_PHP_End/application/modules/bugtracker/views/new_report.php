            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <div class="uk-grid uk-grid-small">
                  ...
                  <div class="uk-width-auto@m">
                    <a href="<?= base_url('bugtracker'); ?>" class="uk-button uk-button-default uk-button-small" style="font-size:16px"><i class="fas fa-arrow-circle-left"></i></a>
                  </div>
                </div>
              </div>
              <div class="uk-card-body">
                ...
                <div class="uk-margin uk-light">
                  <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_title'); ?></label>
                  <div class="uk-form-controls">
                    <div class="uk-inline uk-width-1-1">
                      <span class="uk-form-icon uk-form-icon-flip" style="font-size:16px"><i class="fas fa-pen fa-lg"></i></span>
                ...
                <div class="uk-margin uk-light">
                  <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_description'); ?></label>
                  <div class="uk-form-controls">
