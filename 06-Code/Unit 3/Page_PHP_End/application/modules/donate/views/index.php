        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          <div class="uk-width-1-4@m">
            <ul class="uk-nav uk-nav-default myaccount-nav">
              ...
              <li class="uk-active"><a href="<?= base_url('donate'); ?>" style="font-size:16px"><i class="fas fa-hand-holding-usd"></i> <?=$this->lang->line('navbar_donate_panel'); ?></a></li>
              <?php endif; ?>
          ...
          <div class="uk-width-3-4@m">
            ...
            <div class="uk-alert-success" uk-alert>
              ...
              <p><span class="uk-text-bold" ><i class="far fa-check-circle"></i> <span class="uk-text-bold" style="font-size:16px"><?= $this->lang->line('notification_title_success'); ?>:</span> <?= $this->lang->line('notification_donation_successful'); ?></p>
            </div>
            <?php elseif($this->session->flashdata('donation_status') == 'canceled'): ?>
            <div class="uk-alert-warning" uk-alert>
              <a class="uk-alert-close" uk-close></a>
              <p><span class="uk-text-bold" style="font-size:16px"><i class="fas fa-exclamation-circle"></i> <?= $this->lang->line('notification_title_warning'); ?>:</span> <?= $this->lang->line('notification_donation_canceled'); ?></p>
            </div>
            <?php elseif($this->session->flashdata('donation_status') == 'error'): ?>
            <div class="uk-alert-danger" uk-alert>
              <a class="uk-alert-close" uk-close></a>
              <p><span class="uk-text-bold" style="font-size:16px"><i class="far fa-times-circle"></i> <?= $this->lang->line('notification_title_error'); ?>:</span> <?= $this->lang->line('notification_donation_error'); ?></p>
            </div>
            <?php endif; ?>
