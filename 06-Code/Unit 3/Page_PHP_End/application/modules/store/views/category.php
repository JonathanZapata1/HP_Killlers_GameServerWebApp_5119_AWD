          ...
          <div class="uk-width-1-4@m">
            <div class="uk-card uk-card-default" style="background:#0356b980">
              ...
              <ul class="uk-nav-default nav-store uk-nav-parent-icon" uk-nav>
                <li><a href="<?= base_url('store'); ?>" style="font-size:16px"><i class="fas fa-star"></i> <?= $this->lang->line('store_top_items'); ?></a></li>
                ...
                <div>
                  <div class="blizzcms-item-container">
                    <div class="blizzcms-item-header uk-text-truncate" uk-tooltip="<?= $items->name ?>" uk-toggle="target: #item-<?= $items->id ?>;animation: uk-animation-slide-top-small">
                      ...
                      <?php if($items->type == 1): ?>
                      <span class="uk-text-middle" style="font-size:16px">
                    ...
                    <div id="item-<?= $items->id ?>" class="blizzcms-item-body" hidden>
                      <p class="uk-text-break" style="font-size:16px"><?= $items->description ?></p>
                      <hr class="uk-margin-small">
                      <div class="uk-grid uk-grid-small uk-flex uk-flex-center" data-uk-grid>
                        <div class="uk-width-auto">
                          <?php if($items->price_type == 1): ?>
                          <span class="blizzcms-item-price" style="font-size:16px"><span uk-tooltip="title:<?=$this->lang->line('panel_dp'); ?>"><i class="dp-icon"></i></span><?= $items->dp ?></span>
                          <?php elseif($items->price_type == 2): ?>
                          <span class="blizzcms-item-price" style="font-size:16px"><span uk-tooltip="title:<?=$this->lang->line('panel_vp'); ?>"><i class="vp-icon"></i></span><?= $items->vp ?></span>
                          <?php elseif($items->price_type == 3): ?>
                          <span class="blizzcms-item-price" style="font-size:16px"><span uk-tooltip="title:<?=$this->lang->line('panel_dp'); ?>"><i class="dp-icon"></i></span><?= $items->dp ?> <span class="uk-badge">&amp;</span> <span uk-tooltip="title:<?=$this->lang->line('panel_vp'); ?>"><i class="vp-icon"></i></span><?= $items->vp ?></span>
                          <?php endif; ?>
                        </div>
                        <div class="uk-width-auto">
