          ...
          <div class="uk-card-body">
            <div class="uk-overflow-auto uk-width-1-1 uk-margin-small" >
              <table class="uk-table uk-table-middle uk-table-divider uk-table-small">
                <thead>
                  <tr>
                    <th class="uk-width-medium" style="font-size:16px"><i class="fas fa-info-circle"></i> <?= $this->lang->line('table_header_item_name'); ?></th>
                    <th class="uk-width-medium" style="font-size:16px"><i class="fas fa-list-ul"></i> <?= $this->lang->line('table_header_character'); ?></th>
                    <th class="uk-width-small" style="font-size:16px"><i class="fas fa-coins"></i> <?= $this->lang->line('table_header_price'); ?></th>
                    <th class="uk-table-shrink" style="font-size:16px"><i class="fas fa-sort-numeric-up"></i> <?= $this->lang->line('table_header_quantity'); ?></th>
                    <th class="uk-table-shrink" style="font-size:16px"></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="uk-text-small" style="font-size:16px"><span uk-tooltip="title: <?= $this->lang->line('panel_dp'); ?>"><i class="dp-icon"></i></span><?= $item["dp"]; ?></span>
                      <?php elseif($this->store_model->getPriceType($item["id"]) == 2): ?>
                      <span class="uk-text-small" style="font-size:16px"><span uk-tooltip="title: <?= $this->lang->line('panel_vp'); ?>"><i class="vp-icon"></i></span><?= $item["vp"]; ?></span>
                      <?php elseif($this->store_model->getPriceType($item["id"]) == 3): ?>
                      <span class="uk-text-small" style="font-size:16px"><span uk-tooltip="title: <?= $this->lang->line('panel_dp'); ?>"><i class="dp-icon"></i></span><?= $item["dp"]; ?> <span class="uk-badge">&amp;</span> <span uk-tooltip="title: <?= $this->lang->line('panel_vp'); ?>"><i class="vp-icon"></i></span><?= $item["vp"]; ?></span>
                      <?php endif; ?>
                    </td>
                    <td>
                      <div class="uk-form-controls uk-light">
          ...
          <div class="uk-card-footer">
            <div class="uk-grid uk-grid-small" data-uk-grid>
              <div class="uk-width-expand@s">
                <a href="<?= base_url('store'); ?>" class="uk-button uk-button-default uk-button-small" style="font-size:16px"><i class="fas fa-arrow-circle-left"></i> <?= $this->lang->line('button_buying'); ?></a>
              </div>
              <div class="uk-width-auto@s uk-flex uk-flex-middle">
                <?php if($this->cart->total_items() > 0): ?>
                <p class="uk-margin-small uk-text-small" style="font-size:16px"><span class="uk-text-uppercase uk-text-bold" style="font-size:16px">Total:</span> <span uk-tooltip="title: <?= $this->lang->line('panel_dp'); ?>"><i class="dp-icon"></i></span><?= $this->cart->total_dp(); ?> <span class="uk-badge">&amp;</span> <span uk-tooltip="title: <?= $this->lang->line('panel_vp'); ?>"><i class="vp-icon"></i></span><?= $this->cart->total_vp(); ?></p>
                <?php endif; ?>
              </div>
