    ...
    <div class="main-box">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade in <?php echo((empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                        ...
                        <p style="text-align: justify">
                            MoonShard es una comunidad privada de World of Warcraft orientada a la expansión cataclysm 4.3.4, estilo de juego Blizz.
                        </p>
                        <p><?php elang('edit_on'); ?> MoonShard<?php echo $antiXss->xss_clean(get_config("template")); ?>
                            -WoW</p>
                    </div>
                    <div class="tab-pane fade in <?php echo(!(empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                         id="pills-register">
        ...
        <div class="col-md-4 sidebar">
            ...
            <div class="box1">
                Discord
                <hr style="border-color: #00CCFF;">                
		<iframe src="https://discord.com/widget?id=963273980909846528&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
            </div>
        </div>
    </div>
</div>
